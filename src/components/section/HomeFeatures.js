...
const HomeFeatures = () => {
	return (
		<Box>
			<Carousel interval='2000' stopAutoPlayOnHover='false' index='2'>
				<Stack direction='row' flexWrap='wrap' alignItems='center' justifyContent='space-around'>
					...
					<Box width='50%' m={4} textAlign='left'>
						...
						<Typography sx={{ lineHeight: "2rem", letterSpacing: "0.1rem" }} variant='body1'>
							We offer a range of free resources, including webinars, guides, and tutorials, to help you create and sell
							successful courses on our platform.
						</Typography>
					</Box>
				</Stack>
				...
				<Stack direction='row' flexWrap='wrap' alignItems='center' justifyContent='space-around'>
					...
					<Box width='50%' m={4} textAlign='left'>
						...
						<Typography sx={{ lineHeight: "2rem", letterSpacing: "0.1rem" }} variant='body1'>
							Our platform is available worldwide, which means you can create and sell courses to students from all over
							the globe.
						</Typography>
					</Box>
				</Stack>
