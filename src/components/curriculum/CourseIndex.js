				...
				<Stack direction='row'>
					...
					>
						<Stack alignItems='center'>
							...
							<Box sx={{ height: "500px", width: "100%", bgcolor: "primary.dark", borderRadius: 5 }}></Box>
									...
									<Box key={index} sx={{ width: "100%", height: "100%" }}>
										...
										{index == itemIndex &&
											item.files.map((VideoFile, index) => {
												return (
													<Button variant='contained' size='small' fullWidth key={index} sx={{ textTransform: "none" }}>
														<Checkbox color='third' />
